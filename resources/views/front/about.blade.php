...
<div class="wrapper">
     ...
     <section class="our-services section-padding section-bg2">
        <div class="container">
  ...
  <div class="row justify-content-center">
        ...
        <a href="#" class="service education m-3">
     ...
     <a href="#" class="service credentialing m-3">
         <div class="overlay"></div>
      <div class="circle">
    ...
    <a href="#" class="service wallet m-3">
         <div class="overlay"></div>
      <div class="circle">
      ...
      <p>Sufficient Classrooms</p>
    </a>
   
    <a href="#" class="service human-resources m-3">
         <div class="overlay"></div>
      <div class="circle">
      ...
      <div class="container">
        <div class="row align-items-sm-center align-items-lg-stretch">
          ...
          <div class="learning_img">
              <img src="https://preview.colorlib.com/theme/etrain/img/learning_img.png" alt="logo">
          </div>
        </div>
